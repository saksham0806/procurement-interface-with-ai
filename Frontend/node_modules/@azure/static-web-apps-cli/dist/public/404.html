...
<html lang="en">
  ...
  <body>
    ...
    <footer>
      <div>Azure Static Web Apps emulator (<a rel="noopener noreferrer" target="_blank" href="https://github.com/Azure/static-web-apps-cli/commit/91b159f">main+sha.91b159f</a>)</div>
      <nav>
        <ul>
